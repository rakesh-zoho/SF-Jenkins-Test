...
- Name: lead-creation.spec.js >> Lead Creation Flow >> should close modal when Cancel button is clicked
- Location: tests\lead-creation.spec.js:257:3

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('dialog').filter({ hasText: 'Last Name' }).getByRole('button', { name: 'Cancel' }) resolved to 2 elements:
    1) <button type="button" title="Cancel and close" data-aura-rendered-by="1224:0" class="slds-button slds-button_icon slds-modal__close closeIcon slds-button_icon-bare">…</button> aka getByRole('button', { name: 'Cancel and close' })
...
Call log:
  - waiting for getByRole('dialog').filter({ hasText: 'Last Name' }).getByRole('button', { name: 'Cancel' })
                            ...
                            - group "Name required" [ref=e1922]:
                              ...
                              - generic [ref=e1926]:
                                ...
                                - generic [ref=e1948]:
                                  ...
                                  - textbox "First Name" [active] [ref=e1951]: CancelTest
                                - generic [ref=e1955]:
                                  - generic [ref=e1956]: "*Last Name"
                                  - textbox "Last Name" [ref=e1958]
                          - listitem [ref=e1960]:
                            - generic [ref=e1965]:
                        ...
                        - listitem [ref=e2038]:
                          - group "Address" [ref=e2043]:
                            ...
                            - generic [ref=e2046]:
                              - status [ref=e2047]
                              - generic [ref=e2049]:
                                - generic [ref=e2050]: Street
                                - textbox "Street" [ref=e2052]
                                - status
                              - generic [ref=e2056]:
                                - generic [ref=e2057]: City
                                - textbox "City" [ref=e2059]
                              - generic [ref=e2060]:
                                - generic [ref=e2063]:
                                  - generic [ref=e2064]: Zip/Postal Code
                                  - textbox "Zip/Postal Code" [ref=e2066]
                                - generic [ref=e2069]:
                                  - generic [ref=e2070]: State/Province
                                  - textbox "State/Province" [ref=e2072]
                              - generic [ref=e2076]:
                                - generic [ref=e2077]: Country
                                - textbox "Country" [ref=e2079]
                        - listitem [ref=e2081]:
                          - generic [ref=e2086]:
                            - generic [ref=e2087]: Website
                            - textbox "Website" [ref=e2089]
                  - generic [ref=e2091]:
                    - heading "Additional Information" [level=3] [ref=e2092]:
                      - generic [ref=e2093]: Additional Information
                    - list [ref=e2095]:
                      - generic [ref=e2096]:
                        - generic [ref=e2098]:
                          - listitem [ref=e2100]:
                            - generic [ref=e2105]:
                              - generic [ref=e2106]: No. of Employees
                              - spinbutton "No. of Employees" [ref=e2108]
                          - listitem [ref=e2110]:
                            - generic [ref=e2117]:
                              - generic [ref=e2119]: Lead Source
                              - generic [ref=e2123]:
                                - combobox "Lead Source" [ref=e2124] [cursor=pointer]:
                        ...
                        - generic [ref=e2133]:
                          - listitem [ref=e2135]:
                            - generic [ref=e2141]:
                              - generic [ref=e2142]: Annual Revenue
                              - spinbutton "Annual Revenue" [ref=e2144]
                          - listitem [ref=e2146]:
                            - generic [ref=e2153]:
                              - generic [ref=e2155]: Industry
                              - generic [ref=e2159]:
                                - combobox "Industry" [ref=e2160] [cursor=pointer]:
                                  - generic [ref=e2161]: "--None--"
                                - img [ref=e2165]
                              - status
                  - generic [ref=e2169]:
                    - heading "Description Information" [level=3] [ref=e2170]:
                      - generic [ref=e2171]: Description Information
                    - list [ref=e2173]:
                      - listitem [ref=e2178]:
                        - generic [ref=e2182]:
                          - generic [ref=e2183]: Description
                          - textbox "Description" [ref=e2185]
                          - status
                - generic [ref=e2190]:
                  - generic "Cancel" [ref=e2191]:
                    - button "Cancel" [ref=e2196] [cursor=pointer]
                  - generic "Save & New" [ref=e2197]:
                    - button "Save & New" [ref=e2202] [cursor=pointer]
                  - generic "Save" [ref=e2203]:
                    - button "Save" [ref=e2208] [cursor=pointer]
          - status [ref=e2209]
  - generic:
    - status
```
